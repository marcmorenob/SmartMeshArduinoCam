...
struct SPI_UART_cfg SPI_Uart_config = {
  ...
  //DJE: Disabled flow control for Dust mote connection.
  //Consider adding it again later.
...
//DJE: Redefine SS (SPI chip select) to be pin 4 of Linduino
#define SS_OLD SS
#define SS 4
...
//DJE: Put SS back to its original value
#define SS SS_OLD
